 ...
 */
  [_QWERTY] = LAYOUT_ortho_4x10(
    ...
    KC_ESC, KC_LGUI,      KC_NO,        LT(_LOWER,KC_ESC), KC_SPC,      RSFT_T(KC_ENT), LT(_RAISE,KC_BSPC), KC_NO,       KC_LALT,        KC_LNG1
    ),
 ...
 */
  [_RAISE] = LAYOUT_ortho_4x10(
    ...
    KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_PGDN,
