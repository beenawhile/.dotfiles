 ...
 */
  ...
  [_NUM] = LAYOUT_ortho_4x10(
    KC_LPRN, KC_7,    KC_8,    KC_9,  KC_RPRN, _______, _______, _______, _______, _______,
    KC_LCBR, KC_4,    KC_5,    KC_6,  KC_RCBR, _______, _______, _______, _______, _______,
    KC_LBRC, KC_1,    KC_2,    KC_3,  KC_RBRC, _______, _______, _______, _______, _______,
    _______, _______, KC_DOT,  KC_0,  KC_BSLS, _______, _______, _______, _______, _______
  ),
  ...
  [_SYM] = LAYOUT_ortho_4x10(
    KC_PLUS, KC_AMPR, KC_ASTR, KC_LPRN, KC_MINS, _______, _______, _______, _______, _______,
    KC_DQT,  KC_DLR,  KC_PERC, KC_CIRC, KC_QUOT, _______, _______, _______, _______, _______,
    KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_TILD, _______, _______, _______, _______, _______,
    _______, _______, KC_UNDS, KC_EQL,  KC_PIPE, _______, _______, _______, _______, _______
  ),
