...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_ortho_4x12_1x2uC(
        ...
        _______, _______,  _______,   _______,  _______, _______,          LT(_ADJUST,KC_BSPC), _______, _______, _______, _______ 
    ),
    ...
    [_ADJUST] = LAYOUT_ortho_4x12_1x2uC(
        ...
        _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, KC_PWR
    ),
    [_NUMPAD] = LAYOUT_ortho_4x12_1x2uC(
        ...
        _______, _______, _______, KC_DOT,  KC_0,  KC_UNDS,          _______, _______, _______, _______, _______ 
    ),
    [_FUNC] = LAYOUT_ortho_4x12_1x2uC(
        ...
        _______, _______, _______, _______, KC_SPC,  KC_TAB,           _______, _______, _______, _______, _______ 
    ),
    [_MEDIA] = LAYOUT_ortho_4x12_1x2uC(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______,          KC_MSTP, KC_MPLY, KC_MUTE, _______, _______, _______ 
    ),
    [_MOUSE] = LAYOUT_ortho_4x12_1x2uC(
        ...
        _______, _______, _______, _______, _______,          KC_BTN2, KC_BTN1, KC_BTN3, _______, _______, _______ 
    )
};
