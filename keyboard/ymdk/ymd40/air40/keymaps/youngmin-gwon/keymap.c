...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_ortho_4x12(
        ...
        KC_TAB,       KC_A,             ALT_T(KC_S),  GUI_T(KC_D),    SFT_T(KC_F), CTL_T(KC_G), CTL_T(KC_H), SFT_T(KC_J), GUI_T(KC_K),    ALT_T(KC_L),    KC_SCLN, KC_ENT,
        KC_LSFT,      KC_Z,             ALGR_T(KC_X), KC_C,           KC_V,        KC_B,        KC_N,        KC_M,        KC_COMM,        ALGR_T(KC_DOT), KC_SLSH, KC_LSFT,
        LCTL(KC_SPC), KC_LCTL,  KC_LALT,      KC_LGUI,        MO(1),       KC_SPC,      KC_ENT,      MO(2),       KC_LCTL,        TG(_NUMPAD),    _______, QK_LOCK
    ),
