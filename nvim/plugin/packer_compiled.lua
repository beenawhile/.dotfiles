...
_G.packer_plugins = {
  ...
  ["coc.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  ["rust.vim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/rust.vim",
  ...
  vimtex = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/vimtex",
